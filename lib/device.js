...
export const isTablet = () => {
  ...
  const tabletRegex = /ipad|android(?!.*mobile)|tablet|kindle|playbook|nook|gt-|sm-t|tab/i
...
export const supportsCameraSwitch = () => {
  return isMobileOrTablet() && 'mediaDevices' in navigator && 'getUserMedia' in navigator.mediaDevices
} 